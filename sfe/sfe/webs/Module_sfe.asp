<title>软件中心 - Fast Classifier</title>
<content>
<style type="text/css">
...
<div class="box">
<div class="heading">Fast Classifier<a href="#/soft-center.asp" class="btn" style="float:right;border-radius:3px;margin-right:5px;margin-top:0px;">返回</a></div>
<div class="content">
	<span class="col" style="line-height:30px;width:700px">
	Fast Classifier是高通开发的基于内核的IP包转发引擎，可以提供高速的IP包转发，显著增强低端硬件路由的NAT能力，但由于绕过Linux桥接层，不适合复杂环境的使用。<br />
</div>
</div>
...
$('#sfe-fields').forms([
{ title: '开启Fast Classifier', name: 'sfe_enable', type: 'checkbox', value: ((Apps.sfe_enable == '1')? 1:0)},
{ title: '快速转发引擎运行状态', text: '<font id="sfe_status" name=sfe_status color="#1bbf35">正在获取运行状态...</font>' },
{ title: 'Fast Classifier诊断相关设置（开发人员使用）'},
...
<div class="box">
	<div class="heading">Fast Classifier使用说明： <a class="pull-right" data-toggle="tooltip" title="Hide/Show Notes" href="javascript:toggleVisibility('notes');"><span id="sesdivnotesshowhide"><i class="icon-chevron-up"></i></span></a></div>
	<div class="section content" id="sesdivnotes" style="display:none">
			<li>Fast Classifier并不能加快网速，如果你的带宽没有超过路由的转发能力不建议开启快速转发引擎。</li>
			<li>Fast Classifier会导致防火墙一些功能失效，如fwmark。</li>
			<li>Fast Classifier会导致石像鬼QOS失效。</li>
			<li>Fast Classifier会导致多拨失效。</li>
	</div>
</div>
