    ...
    <div class="content">
      ...
      <script type="text/javascript">
        ...
        $('#aria2-fields').forms([
          ...
          { title: 'Aria2版本', name: 'aria2_version', text: Apps.aria2_version || '1.32.0' },
          ...
          { title: '自定义配置项', name: 'aria2_custom', type: 'textarea', maxlen: 20000, size: 20000, value: Apps.aria2_custom },
